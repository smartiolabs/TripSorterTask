...
namespace src\TripSorter;

/**
 * Class TripSorter
 *
 * @package src\TripSorter
 */
class TripSorter
{
    ...
    protected static $transportation = array(
        'train' => 'src\TripSorter\Transportation\Train',
        'bus' => 'src\TripSorter\Transportation\Bus',
        'plane' => 'src\TripSorter\Transportation\Plane',
    );
